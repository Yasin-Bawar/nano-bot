-- =====================================================
-- HOME PAGE SETTINGS SCHEMA
-- Complete database schema for dynamic home page editor
-- =====================================================
...
-- Table: home_features
-- Stores feature items for the features showcase section
...
-- Controls visibility and content of various homepage sections
...
-- Public read access for all home settings tables
...
-- Admin write access for hero settings
...
-- Admin write access for features
...
-- Admin write access for section settings
...
-- Create storage bucket for home page images (if not exists)
