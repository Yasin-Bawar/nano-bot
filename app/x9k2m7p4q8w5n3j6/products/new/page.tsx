    ...
    try {
      ...
      if (specs.length > 0 && product) {
        ...
        if (specsData.length > 0) {
          ...
          if (specsError) console.error("Error inserting specs:", specsError)
        }
      }

      // Insert features
      if (features.length > 0 && product) {
      ...
      if (colors.length > 0 && product) {
        ...
        if (colorsData.length > 0) {
          ...
          if (colorsError) console.error("Error inserting colors:", colorsError)
        }
      }

      alert("محصول با موفقیت اضافه شد!")
      router.push("/x9k2m7p4q8w5n3j6/products")
    } catch (error: any) {
